...
from interview_response.schemas import (
    CandidateResponseOut,
...
from interview_response.service_hr import (
    get_response_detail,
...
async def patch_tab_switch(
    call_id: str,
    data: TabSwitchUpdate,
    current_user: dict = Depends(require_candidate),
) -> dict:
