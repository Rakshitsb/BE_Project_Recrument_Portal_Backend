...
from app.schemas.candidate_schema import ResumeData, CreateProfileRequest, CandidateProfile
...
async def create_profile(
    ...
    summary_parts = [
        ...
        "Experience: " + "; ".join([f"{exp.role} at {exp.company}" for exp in profile_data.experience]),
        "Education: " + "; ".join([f"{edu.degree} at {edu.institution}" for edu in profile_data.education]),
